import { Entity, Column, Index, CreateDateColumn, UpdateDateColumn, PrimaryGeneratedColumn, PrimaryColumn } from 'typeorm';
...
export class Point {
    ...
    @Column({ type: 'varchar', length: 20, nullable: true, name: 'tracker_device_license_plate' })
    trackerDeviceLicensePlate: string;

    @Column({ type: 'varchar', length: 100, nullable: true, name: 'tracker_device_alias' })
    ...
    @Column({ type: 'double precision', nullable: true, name: 'tracker_device_altitude' })
    trackerDeviceAltitude: number;

    // ─── Temporal ─────────────────────────────────────────────────────────────────
    @Column({ type: 'timestamptz', nullable: true, name: 'tracker_device_shipping_date' })
    ...
    // ─── Distancias ───────────────────────────────────────────────────────────────
    @Column({ type: 'double precision', default: 0, name: 'tracker_device_distance' })
    trackerDeviceDistance: number;

    @Column({ type: 'double precision', default: 0, name: 'tracker_device_total_distance' })
    ...
    @Column({ type: 'real', default: 0, name: 'tracker_device_jurisdiction_km_day' })
    trackerDeviceJurisdictionKmDay: number;

    @Column({ type: 'real', default: 0, name: 'tracker_device_no_jurisdiction_km_day' })
    trackerDeviceNoJurisdictionKmDay: number;

    // ─── Tiempos conducción / estacionamiento (segundos) ─────────────────────────
    @Column({ type: 'integer', default: 0, name: 'tracker_device_driving_time_in_jurisdiction' })
    trackerDeviceDrivingTimeInJurisdiction: number;

    @Column({ type: 'integer', default: 0, name: 'tracker_device_driving_time_out_of_jurisdiction' })
    trackerDeviceDrivingTimeOutOfJurisdiction: number;

    @Column({ type: 'integer', default: 0, name: 'tracker_device_parking_time_in_jurisdiction' })
    trackerDeviceParkingTimeInJurisdiction: number;

    @Column({ type: 'integer', default: 0, name: 'tracker_device_parking_time_out_of_jurisdiction' })
    trackerDeviceParkingTimeOutOfJurisdiction: number;

    @Column({ type: 'integer', default: 0, name: 'tracker_device_tactical_parking' })
    ...
    @Column({ type: 'real', default: 0, name: 'tracker_device_total_engine_hours' })
    trackerDeviceTotalEngineHours: number;

    @Column({ type: 'real', default: 0, name: 'tracker_device_engine_hours_based_on_ignition' })
    trackerDeviceEngineHoursBasedOnIgnition: number;

    @Column({ type: 'real', default: 0, name: 'tracker_device_engine_hours_based_on_ignition_and_stopped' })
    trackerDeviceEngineHoursBasedOnIgnitionAndStopped: number;

    // ─── Señal y hardware ─────────────────────────────────────────────────────────
    @Column({ type: 'smallint', nullable: true, name: 'tracker_device_gsm_signal' })
    trackerDeviceGsmSignal: number;

    @Column({ type: 'smallint', nullable: true, name: 'tracker_device_battery' })
    trackerDeviceBattery: number;

    @Column({ type: 'real', nullable: true, name: 'tracker_device_battery_current_amps' })
    ...
    @Column({ type: 'smallint', nullable: true, name: 'tracker_device_data_mode' })
    trackerDeviceDataMode: number;

    @Column({ type: 'smallint', nullable: true, name: 'tracker_device_network_type' })
    trackerDeviceNetworkType: number;

    @Column({ type: 'integer', nullable: true, name: 'tracker_device_gsm_area_code' })
    trackerDeviceGsmAreaCode: number;

    @Column({ type: 'bigint', nullable: true, name: 'tracker_device_active_gsm_operator' })
    ...
    @Column({ type: 'smallint', nullable: true, name: 'tracker_device_packet_id' })
    ...
    @Column({ type: 'smallint', nullable: true, name: 'tracker_device_gnss_state' })
    trackerDeviceGnssState: number;

    @Column({ type: 'smallint', nullable: true, name: 'tracker_device_number_of_satellites' })
    ...
    @Column({ type: 'uuid', nullable: true, name: 'tracker_device_id_municipality' })
    ...
    @Column({ type: 'boolean', default: false, name: 'tracker_device_inside_geofence' })
    trackerDeviceInsideGeofence: boolean;

    @Column({ type: 'boolean', default: false, name: 'tracker_device_inside_quadrant' })
    trackerDeviceInsideQuadrant: boolean;

    @Column({ type: 'boolean', default: false, name: 'tracker_device_inside_sector' })
    trackerDeviceInsideSector: boolean;

    @Column({ type: 'boolean', default: false, name: 'tracker_device_inside_any_sector' })
    trackerDeviceInsideAnySector: boolean;

    @Column({ type: 'varchar', length: 100, nullable: true, name: 'tracker_device_inside_any_sector_name' })
    trackerDeviceInsideAnySectorName: string;

    @Column({ type: 'uuid', nullable: true, name: 'tracker_device_inside_any_sector_id' })
    ...
    @Column({ type: 'varchar', length: 100, nullable: true, name: 'tracker_device_alarm' })
    trackerDeviceAlarm: string;

    // ─── Combustible ─────────────────────────────────────────────────────────────
    @Column({ type: 'real', nullable: true, name: 'tracker_device_gallons_per_km' })
    trackerDeviceGallonsPerKm: number;

    @Column({ type: 'real', nullable: true, name: 'tracker_device_fuel_consumed_per_day' })
