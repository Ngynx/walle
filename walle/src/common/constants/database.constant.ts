...
export const POSTGRES_USER = 'ngynx';
export const POSTGRES_PASSWORD: string = 'ngynx';
export const POSTGRES_DB = 'walledb';
export const POSTGRES_SYNC = false; // Disabled to allow manual partition management
